...
#define STRING_CONFIG_H_AUTHOR "(Kokorone, Artillery-X1 SGen L V2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Artillery X1"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 28, -33, -1.22 }
