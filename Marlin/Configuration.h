...
#define STRING_CONFIG_H_AUTHOR "(Kokorone SGenL-V2 CR-10)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Koko CR-10"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 1, -55, -1.10 }
...
#define HOMING_FEEDRATE_MM_M { (70*60), (70*60), (12*60) }
